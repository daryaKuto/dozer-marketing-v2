...
const DemoFormHubspot: React.FC = () => {
  ...
  const validate = () => {
    ...
    if (!formData.phoneNumber || !/^\+\d\(\d{3}\)\d{3}-\d{4}$/.test(formData.phoneNumber)) {
      newErrors.phoneNumber = "A valid phone number in format +x(xxx)xxx-xxxx is required.";
    }
  ...
  return (
    <div className="max-w-lg mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* First Name */}
        <div>
          <label htmlFor="firstName" className="block text-lg font-nav-bar text-dark-grey">
            First Name
          </label>
          <input
            type="text"
        ...
        {/* Last Name */}
        <div>
          <label htmlFor="lastName" className="block text-lg font-nav-bar text-dark-grey">
            Last Name
          </label>
          <input
            type="text"
