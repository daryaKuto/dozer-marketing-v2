    ...
    <section className='max-container padding-container py-16 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center'>
      ...
      <div>
        ...
        <p className='text-base text-gray-700 mb-6'>
          With 360° of view, our cameras can see the cabin, bucket, and
        ...
        <ul className='space-y-4'>
          <li className='flex items-start'>
            ...
            <p className='text-base text-gray-700'>
              IP-6/7 rated camera housing withstands the harsh elements of any
              jobsite.
            </p>
          </li>
          <li className='flex items-start'>
            <span className='w-5 h-5 bg-dozer-yellow mr-4 flex-shrink-0'></span>
            <p className='text-base text-gray-700'>
              View 360° of context around vehicles to survey productivity,
              dispute rework, or review safety events.
            </p>
          </li>
        </ul>
      </div>
