      ...
      <div>
        ...
        <div className='flex flex-col md:flex-row gap-6'>
          ...
          <div className='text-dozer-yellow font-bold text-base md:w-1/2'>
            Track and manage all of your assets in the field with a dashboard
            that lets you know what equipment is operating and where.
          </div>

          {/* Right Section - Bullet Points */}
          <div className='md:w-1/2'>
            <div className='flex items-start mb-2'>
              <span className='text-dozer-yellow font-bold text-lg mr-2'>
                01
              </span>
